    ...
    public function listar(){
        ...
        $method = $_SERVER['REQUEST_METHOD'];
            ...
            foreach($compras as $compra){
                ...
                $compra->button = 
                "<a href=".ROOT."compra/mostrar/". $this->encriptar($compra->id) ."' class='mostrar btn btn-info'><i class='fas fa-search'></i></a>".
                "<a href=".ROOT."compra/compraPDF/". $this->encriptar($compra->id) ."' class='pdf btn btn-danger m-1'><i class='fas fa-file-pdf'></i></a>";
            }
